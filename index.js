...
/**
 * Determina la pestaña inicial desde el hash de la URL
 */
...
/**
 * Actualiza el hash de la URL sin causar scroll
 */
...
function getDownloadButtonHTML(item, itemId) {
    try {
        ...
        console.error('Error generando botón de descarga:', error);
        return `
...
function handleSuggestionSubmit(e) {
    ...
    try {
        ...
        showToast('Error al enviar la sugerencia. Por favor, inténtalo de nuevo.', 'error');
    }
}
...
*Sugerencia enviada desde [FoxWeb](https://foxweb.pages.dev)*
        ...
        console.error('Error abriendo issue de GitHub:', error);
        showToast('Error al abrir GitHub. Por favor, inténtalo manualmente.', 'error');
    }
}
...
function openNotificationCenter() {
    try {
        ...
        console.error('Error abriendo centro de notificaciones:', error);
    }
}
...
function closeNotificationCenter() {
    try {
        ...
        console.error('Error cerrando centro de notificaciones:', error);
    }
}
...
function handleHashChange() {
    try {
        ...
        if (hash && validTabs.includes(hash) && hash !== AppState.currentTab) {
            AppState.currentTab = hash;
            openTab(hash);
        }
    } catch (error) {
        console.error('Error manejando cambio de hash:', error);
    }
}
...
function initFloatingButtons() {
    try {
        ...
        console.error('Error inicializando botones flotantes:', error);
    }
}
...
console.log(`✅ FoxWeb v${CONFIG.version} listo con sistema de hash completo`);
